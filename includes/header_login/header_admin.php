    ...
    <div class="header-right">
        ...
        <div class="navigation">
            <ul> 
                ...
                <li class="overview selected_ovr"><a href="http://localhost/shafiurcse02/admin_pag_hotel_13.php" title="Admin Page">Admin Page</a></li>					
              ...
              <li class="overview selected_ovr"><a href="http://localhost/shafiurcse02/resistration.php" title="Adding new admin">Add Admin</a></li>   		
                <li class="overview selected_ovr"><a href="http://localhost/shafiurcse02/user_logout.php" title="logOut ">logout</a></li> 
                <li class="overview selected_ovr"><a href="http://localhost/shafiurcse02/food_add.php" title="Dining">Food</a></li> 
                <li class="overview selected_ovr"><a href="http://localhost/shafiurcse02/meeting.php" title="Meetings &amp;  Events">Meeting</a></li> 
            </ul> 
        </div>
